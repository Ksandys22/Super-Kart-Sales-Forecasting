...
if st.button("Predict", type='primary'):
    # !!! IMPORTANT: Replace <user_name> and <space_name> with your actual Hugging Face username and space name.
    # Example: https://your_username-your_space_name.hf.space/v1/predict
